...
import { Users, Clock, CheckCircle, Utensils } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  }, [stats.totalTables, stats.occupiedTables, stats.pendingOrders, stats.activeOrders]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm">
        <div className="px-4 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-orange-600">{t('admin.dashboard.title')}</h1>
      ...
      <div className="p-4 space-y-6">
        ...
        <Card>
          <CardHeader className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0">
            <CardTitle className="text-lg sm:text-xl">{t('admin.dashboard.tablesOverview')}</CardTitle>
          ...
          <CardContent>
            {tablesWithCustomers.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p>{t('admin.dashboard.noTables', { defaultValue: 'No tables available' })}</p>
              </div>
            ) : (
